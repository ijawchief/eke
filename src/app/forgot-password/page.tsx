      ...
      <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 w-full max-w-sm relative z-10">
        ...
        {sent ? (
          <div className="text-center space-y-4">
            ...
            <Link href="/login" className="inline-flex items-center gap-1.5 text-sm text-orange-600 hover:underline font-semibold mt-2">
          ...
          <>
            ...
            <Link href="/login" className="flex items-center justify-center gap-1.5 text-xs text-gray-400 hover:text-gray-600 mt-5 transition-colors">
