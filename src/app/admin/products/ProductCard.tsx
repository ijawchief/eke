...
export function ProductCard({ id, name, slug, price, active, earned, sales, thumb }: Props) {
  ...
  return (
    <div className={`bg-white rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4 px-5 py-5 hover:shadow-md transition-shadow ${deleting ? "opacity-40 pointer-events-none" : ""}`}>
      ...
      {/* Thumbnail */}
      <div style={{ width: 200, height: 200, flexShrink: 0, borderRadius: 16, overflow: "hidden", border: "1px solid #f3f4f6" }}>
        {thumb
