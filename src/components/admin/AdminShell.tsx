  ...
  const NavLinks = () => (
    <>
      ...
      <div className="px-3 pb-4 space-y-1">
        ...
        <a href="/api/admin/logout" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-white/40 hover:text-white hover:bg-white/10 transition-all">
